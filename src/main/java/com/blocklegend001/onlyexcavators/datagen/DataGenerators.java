...
public class DataGenerators {
    ...
    public static void gatherData(final GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new ModItemTagsProvider(packOutput, lookupProvider, blockTagsProvider.contentsGetter(), OnlyExcavators.MOD_ID, existingFileHelper));
