...
public class ModItems {
    ...
    public static void addItemsToItemGroup() {
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, WOODEN_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, STONE_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, IRON_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, GOLD_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, LAPIS_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, REDSTONE_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, DIAMOND_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, EMERALD_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, OBSIDIAN_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYEXCAVATORS, NETHERITE_EXCAVATOR);
    }
